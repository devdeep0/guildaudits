              ...
              <div className="dark:bg-black text-black  dark:text-white absolute hidden h-auto left-0 w-full group-hover:block top-[70px] hover:cursor-default  bg-white  p-4 ">
                <div className='w-full h-full flex'>
                  ...
                  <div className='w-[400px]  h-full dark:bg-black text-black bg-white dark:text-white'>
                    ...
                    <div className='ml- flex gap-4  p-3  dark:hover:bg-[#f0efed] dark:hover:bg-opacity-20 hover:bg-opacity-10 hover:bg-black'>
                      <div className='h-auto w-[50px] flex items-center justify-center'><svg fill="#000000" viewBox="0 0 24 24" id="research-left" data-name="Flat Line" xmlns="http://www.w3.org/2000/svg" className="icon flat-line"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><circle id="secondary" cx="16" cy="10" r="3" style={{ fill: '#2cba48', strokeWidth: 2 }}></circle><path className='dark:stroke-white stroke-black' id="primary" d="M7,17V12m4,5V15M21,15l-2.83-2.83M13,10a3,3,0,1,0,3-3A3,3,0,0,0,13,10Z" style={{ fill: 'none', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 2 }}></path><path className='dark:stroke-white stroke-black' id="primary-2" data-name="primary" d="M17,17v3a1,1,0,0,1-1,1H4a1,1,0,0,1-1-1V4A1,1,0,0,1,4,3H16" style={{ fill: 'none', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: 2 }}></path></g></svg>
                      </div>
                    <div className='flex flex-col '>
                  ...
                  <div className='w-[350px]  h-full dark:bg-black text-black bg-white dark:text-white'>
                   ...
                   <div className='flex items-center flex-row justify-center gap-4 h-[60px] '>
                    <div className='flex gap-4 h-full items-center p-4 dark:hover:bg-[#f0efed] dark:hover:bg-opacity-20 hover:bg-opacity-10 hover:bg-black'> 
            ...
            <div className="dark:bg-black text-black bg-white dark:text-white absolute hidden  h-auto left-0 w-full group-hover:block hover:cursor-default top-[70px] text-md  p-4 ">
                <div className='w-full h-full flex'>
                  ...
                  <div className='w-[360px]  h-full'>
                    ...
                    <div className='ml- flex gap-4 p-3 rounded-md dark:hover:bg-[#f0efed] dark:hover:bg-opacity-20 hover:bg-opacity-10 hover:bg-black'>
                      <div className='h-auto w-[40px] flex items-center justify-center'><svg fill="#000000" viewBox="-2 -5 24 24" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin" ><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path className='dark:stroke-white ' d="M2 0h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm0 2v10h16V2H2zm3 6h6a1 1 0 0 1 0 2H5a1 1 0 1 1 0-2zm10-5h2v2h-2V3z"></path></g></svg>
                      </div>
                    <div className='flex flex-col '>
                    ...
                    <div className='ml- flex gap-4  p-3 rounded-md dark:hover:bg-[#f0efed] dark:hover:bg-opacity-20 hover:bg-opacity-10 hover:bg-black'>
                      <div className='h-auto w-[40px] flex items-center justify-center ' ><svg xmlns="http://www.w3.org/2000/svg" className='dark:fill-white ' fill="#000000" viewBox="0 0 36 36"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><rect x="6.48" y="18" width="5.76" height="11.52" rx="1" ry="1"></rect><rect x="15.12" y="6.48" width="5.76" height="23.04" rx="1" ry="1"></rect><rect x="23.76" y="14.16" width="5.76" height="15.36" rx="1" ry="1"></rect></g></svg></div>
                    <div className='flex flex-col '>
                    ...
                    <div className='ml- flex gap-4  p-3 rounded-md dark:hover:bg-[#f0efed] dark:hover:bg-opacity-20 hover:bg-opacity-10 hover:bg-black'>
                      <div className='h-auto w-[40px]  flex items-center justify-center'><svg viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>about</title> <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <g id="about-white" fill="#000000" transform="translate(42.666667, 42.666667)"> <path className='dark:stroke-white dark:fill-white' d="M213.333333,3.55271368e-14 C95.51296,3.55271368e-14 3.55271368e-14,95.51168 3.55271368e-14,213.333333 C3.55271368e-14,331.153707 95.51296,426.666667 213.333333,426.666667 C331.154987,426.666667 426.666667,331.153707 426.666667,213.333333 C426.666667,95.51168 331.154987,3.55271368e-14 213.333333,3.55271368e-14 Z M213.333333,384 C119.227947,384 42.6666667,307.43872 42.6666667,213.333333 C42.6666667,119.227947 119.227947,42.6666667 213.333333,42.6666667 C307.44,42.6666667 384,119.227947 384,213.333333 C384,307.43872 307.44,384 213.333333,384 Z M240.04672,128 C240.04672,143.46752 228.785067,154.666667 213.55008,154.666667 C197.698773,154.666667 186.713387,143.46752 186.713387,127.704107 C186.713387,112.5536 197.99616,101.333333 213.55008,101.333333 C228.785067,101.333333 240.04672,112.5536 240.04672,128 Z M192.04672,192 L234.713387,192 L234.713387,320 L192.04672,320 L192.04672,192 Z" id="Shape"> </path> </g> </g> </g></svg>
                      </div>
                    <div className='flex flex-col '>
                  ...
                  <div className='w-[350px]  h-full'>
                   ...
                   <div className='flex  flex-row justify-center items-center h-[60px] w-2/4 gap-2 dark:hover:bg-[#f0efed] dark:hover:bg-opacity-20 hover:bg-opacity-10 hover:bg-black p-4'>
                      <div className='h-auto w-[30px] flex items-center justify-center'><svg xmlns="http://www.w3.org/2000/svg" width="18" height="auto" viewBox="0 0 20 20" fill="none"><path className='dark:fill-white' fill-rule="evenodd" clip-rule="evenodd" d="M13.226 18L9.19002 12.2473L4.13753 18H2L8.24169 10.8953L2 2H7.48796L11.2918 7.42183L16.0578 2H18.1953L12.2433 8.77562L18.7139 18H13.226ZM15.6063 16.3782H14.1673L5.06062 3.62182H6.49988L10.1472 8.72957L10.7779 9.6159L15.6063 16.3782Z" fill="#242E36"></path></svg></div>
                   ...
                   <div className='flex  flex-row justify-center h-[60px] w-2/4 gap-2 dark:hover:bg-[#f0efed] dark:hover:bg-opacity-20 hover:bg-opacity-10 hover:bg-black p-4'>
                   ...
                   <div className='flex  flex-row justify-center h-[60px] w-2/4 gap-3 dark:hover:bg-[#f0efed] dark:hover:bg-opacity-20 hover:bg-opacity-10 hover:bg-black p-4'>
      ...
      <g>
        <path style={{ fill: "#F61C0D" }} d="M365.257,67.393H95.744C42.866,67.393,0,110.259,0,163.137v134.728 c0,52.878,42.866,95.744,95.744,95.744h269.513c52.878,0,95.744-42.866,95.744-95.744V163.137 C461.001,110.259,418.135,67.393,365.257,67.393z M300.506,237.056l-126.06,60.123c-3.359,1.602-7.239-0.847-7.239-4.568V168.607 c0-3.774,3.982-6.22,7.348-4.514l126.06,63.881C304.363,229.873,304.298,235.248,300.506,237.056z"></path>
            ...
            <ul className='flex gap-5 items-center justify-center'>
              <li><button className=''><ThemeSwitch/></button></li>
