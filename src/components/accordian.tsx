...
function Accordian() {
  return (
    <Accordion type="single" collapsible className=" w-5/6 flex flex-col gap-5 dark:bg-black text-black bg-white dark:text-white ">
    <AccordionItem value="item-1" className='  p-3 rounded-md dark:bg-[#ecf2f6] text-black bg-[#ecf2f6] dark:text-black '>
      <AccordionTrigger className=''>what is guild?</AccordionTrigger>
      <AccordionContent>
      guild is a smart contract auditing and research company, building state of the art security tools while helping world's biggest protocols secure their codebase and users.
      </AccordionContent>
    </AccordionItem>
    <AccordionItem value="item-2" className='dark:bg-[#ecf2f6] text-black bg-[#ecf2f6] dark:text-black p-3 rounded-md'>
    ...
    <AccordionItem value="item-3 " className='dark:bg-[#ecf2f6] text-black bg-[#ecf2f6] dark:text-black p-3 rounded-md'>
      <AccordionTrigger>How can I partner with guild to audit my protocol or codebase?</AccordionTrigger>
      <AccordionContent>
    ...
    <AccordionItem value="item-4" className='dark:bg-[#ecf2f6] text-black bg-[#ecf2f6] dark:text-black p-3 rounded-md'>
    ...
    <AccordionItem value="item-5" className='dark:bg-[#ecf2f6] text-black bg-[#ecf2f6] dark:text-black p-3 rounded-md'>
    ...
    <AccordionItem value="item-6" className='dark:bg-[#ecf2f6] text-black bg-[#ecf2f6] dark:text-black p-3 rounded-md'>
