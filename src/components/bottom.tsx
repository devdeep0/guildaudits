...
const EncryptButton = () => {
  ...
  return (
    <motion.button
      ...
      className="group relative overflow-hidden rounded-lg border-[1px] border-neutral-500 bg-neutral-700 px-8 py-3 font-mono font-bold text-xl uppercase text-neutral-300 transition-colors hover:text-green-300"
    >
