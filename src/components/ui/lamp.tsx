...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[1200px] flex-col items-center justify-center overflow-hidden bg-black w-full isolate rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-200 items-center justify-center isolate z-0 ">
        <motion.div
